    ...
    return (
      <section className='calendar'>
        <header className='calendar-header'>
          <article className='arrow' style={leftArrow} onClick={this.props.updateMonth.previous}></article>
          <h4 className='month'>{this.props.monthTitle}</h4>
          <article className='arrow' style={rightArrow} onClick={this.props.updateMonth.next}></article>
        </header>
        <main>
